...
void Color::init ()
{
...
#endif
    {
        ...
        int temp_settings_denoiselabgamma = 2;//like in rt debug
        switch(temp_settings_denoiselabgamma) {
        ...
        #pragma omp section
#endif
       // linearGammaTRC = cmsBuildGamma(nullptr, 1.0); //todoooooooooooooooooooo hadar!!!!
    }
}
